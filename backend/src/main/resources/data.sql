...
-- 4. UNIDADES DE TRANSPORTE (RF-39, RF-42) - todas inician en Almacén Central (27, 14) con códigos TTNN
...
INSERT INTO unidades_transporte (id, codigo, tipo_id, estado_operativo, pos_x, pos_y, carga_actual, conductor_id, activo, fecha_ultimo_cambio_estado)
VALUES (5, 'TM01', 2, 'DISPONIBLE', 27, 14, 0, 5, true, CURRENT_TIMESTAMP);
INSERT INTO unidades_transporte (id, codigo, tipo_id, estado_operativo, pos_x, pos_y, carga_actual, conductor_id, activo, fecha_ultimo_cambio_estado)
VALUES (6, 'TM02', 2, 'DISPONIBLE', 27, 14, 0, 6, true, CURRENT_TIMESTAMP);
INSERT INTO unidades_transporte (id, codigo, tipo_id, estado_operativo, pos_x, pos_y, carga_actual, conductor_id, activo, fecha_ultimo_cambio_estado)
VALUES (7, 'TM03', 2, 'DISPONIBLE', 27, 14, 0, 7, true, CURRENT_TIMESTAMP);

-- Bicicletas (id_tipo = 3, cap = 4)
INSERT INTO unidades_transporte (id, codigo, tipo_id, estado_operativo, pos_x, pos_y, carga_actual, conductor_id, activo, fecha_ultimo_cambio_estado)
VALUES (8, 'TB01', 3, 'DISPONIBLE', 27, 14, 0, 8, true, CURRENT_TIMESTAMP);
INSERT INTO unidades_transporte (id, codigo, tipo_id, estado_operativo, pos_x, pos_y, carga_actual, conductor_id, activo, fecha_ultimo_cambio_estado)
VALUES (9, 'TB02', 3, 'DISPONIBLE', 27, 14, 0, 9, true, CURRENT_TIMESTAMP);
INSERT INTO unidades_transporte (id, codigo, tipo_id, estado_operativo, pos_x, pos_y, carga_actual, conductor_id, activo, fecha_ultimo_cambio_estado)
VALUES (10, 'TB03', 3, 'DISPONIBLE', 27, 14, 0, 10, true, CURRENT_TIMESTAMP);
